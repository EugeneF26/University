...
public class ProfessorRepository implements CrudRepository<Professor> {
	...
	public int save(Professor professor) {
		return this.jdbcTemplate.update(
		        "INSERT INTO PROFESSORS (professorName, professorSurname, professorPatronymic) VALUES (?,?,?)", 
	...
	public Professor find(int id) {
		return this.jdbcTemplate.queryForObject("SELECT professorId, professorName, professorSurname, professorPatronymic "
				+ "FROM PROFESSORS WHERE professorId = ?;", 
	...
	public int update(Professor professor) {
		return this.jdbcTemplate.update(
		        "UPDATE PROFESSORS SET professorName=?, professorSurname=?, professorPatronymic=? "
		        + "WHERE professorId=? ", professor.getProfessorName(), professor.getProfessorSurname(), 
